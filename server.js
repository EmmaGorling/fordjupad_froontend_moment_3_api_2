...
const init = async () => {
    const server = Hapi.server({
        ...
        routes: {
            cors: {
                origin: ['emad2301-fordjupad-frontend-3.netlify.app', 'http://localhost:5500', 'https://www.thunderclient.com', 'http://localhost:5173', 'https://forjupad-frontend-moment-3-api.onrender.com'],
